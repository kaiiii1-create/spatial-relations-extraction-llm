...
3. Do not include:
   - Motion or action verbs (e.g. went, built, traveled, etc)
   - Identity or naming relations (e.g. called, known as, described as, one of the..., etc)
     Incorrect example (do not generate this):
   ...
   - Abstract or emotional language (e.g. beauty, silence, fear, etc)
   - Perceptual/viewpoint expressions (e.g. from which, offers a view of, etc)
   - Classification statements such as: "X is one of the mountains that...", "X is part of...", "X belongs to..."These indicate group membership, not spatial arrangement.
